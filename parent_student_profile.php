		...
		<div class="body_wrapper">
			...
			<div class="content">
				<div class="side_menu">
					...
					<li><a href="parent_student_profile.php" class="active"><div class="glyphicon glyphicon-user"></div>&nbsp Student Details</a></li>
				<!--	<li><a href="parent_student_attend.php"><div class="glyphicon glyphicon-calendar"></div>&nbsp Attendance</a></li>-->
				</div>
				<div class="notif">
					<table class="table">
						<tr>
